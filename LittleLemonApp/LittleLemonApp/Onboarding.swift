...
//                        .background(isFormValid ? Color.primaryColor1 : Color.gray) // Gray out the button if form is invalid
//                        .cornerRadius(8)
//                }
...
//                    UserDefaults.standard.set(globalPhone, forKey: "globalPhone")
//                }
//                
//                
//            } // VStack
            ...
            VStack {
                ...
                NavigationLink {
                    ...
                    Text("Register")
                        ...
                        .foregroundStyle(.white)
                        .frame(width: 352, height: 44)
                        .background(isFormValid ? Color.primaryColor1 : Color.gray)
                        .cornerRadius(8)
                }
                ...
                if UserDefaults.standard.bool(forKey: kIsLoggedIn) {
                    ...
                    DispatchQueue.main.async {
                        if let windowScene = UIApplication.shared.connectedScenes.first as? UIWindowScene {
                            windowScene.windows.first?.rootViewController = UIHostingController(rootView: Home())
                        }
                    }
                }
            }
